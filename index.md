...
<sup>(a)</sup> Para reforçar a importância da discussão oral, pode-se requerer uma classificação mínima de “Satisfatório” nesta componente para obter aprovação no trabalho, ou pode-se colocar um teto à classificação no projeto com base na classificação nesta componente.
